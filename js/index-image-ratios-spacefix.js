...
function scaleCollage() {
    ...
    for (i = 0; i < upperImages.length; i++) {
        upperImages[i].style.height = (window.innerHeight / 2 - headerH - borders).toString().concat("px");
        lowerImages[i].style.height = (window.innerHeight / 2 - headerH - borders).toString().concat("px");
    }
