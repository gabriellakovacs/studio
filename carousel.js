...
var stepcarousel={
	ajaxloadingmsg: '<div style="margin: 1em; font-weight: bold"><img src=2images/loading.gif" style="vertical-align: middle" /></div>', //customize HTML to show while fetching Ajax content
...
stepcarousel.setup({
	...
	defaultbuttons: {enable: true, moveby: 1, leftnav: ['left.png', -5, 80], rightnav: ['right.png', -20, 80]},
